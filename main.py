...
def parse_args():
    ...
    parser.add_argument("--val_dir", type=str, default="./dataset/processed/cifar-10/val_data", help="验证集数据位置")
    parser.add_argument("--val_labels", type=str, default="./dataset/processed/cifar-10/val_annotations.csv", help="验证集数据标签csv")
    parser.add_argument("--test_dir", type=str, default="./dataset/processed/cifar-10/test_data", help="测试集数据位置")
    parser.add_argument("--test_labels", type=str, default="./dataset/processed/cifar-10/test_annotations.csv", help="测试集数据标签csv")
