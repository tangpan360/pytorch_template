...
def parse_args():
    ...
    parser.add_argument("--log_dir", type=str, default="./logs/ag_news/", help="日志文件夹路径")
    ...
    parser.add_argument("--save_path", type=str, default="./checkpoints/ag_news/best_model.pth",
